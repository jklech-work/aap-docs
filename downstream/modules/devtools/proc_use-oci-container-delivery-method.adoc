...
* You have access to the OpenShift project where Red Hat Developer Hub is installed.
...
. Create the authentication secret in the OpenShift project where Red Hat Developer Hub is installed.
+
